...
const DISABLE_RULES = {
  ...
  // ✅ 三星說明：hit4 在三星模式永遠是 0（三星只需命中3個，不可能hit4）
  // 因此這條件在三星下等同：「50期後 hit3=0 且 ROI差 → 淘汰」
  // hit4CountFloorH=0 這個欄位對三星是無效條件（永遠成立），實際靠 hit3CountFloorH 和 roiFloorH 過濾
  minRoundsH: 50,
  hit3CountFloorH: 0,
  hit4CountFloorH: 0,  // 三星不可能hit4，這條永遠成立，淘汰條件實際由 hit3CountFloorH 決定
  roiFloorH: -0.70,
